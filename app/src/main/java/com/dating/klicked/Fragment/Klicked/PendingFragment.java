...
import com.dating.klicked.databinding.FragmentPendingBinding;
...
public class PendingFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, PendingUserPresent.PendingUserView, PendingAdapter.onPendingClicked {
    FragmentPendingBinding binding;
    private Context context;
    private Dialog dialog;
    private View view;
    NavController navController;
    PendingUserPresent present;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        present = new PendingUserPresent(this);

        present.GetPendingUserSuccess(getContext());
    ...
    @Override
    public void onGetPendingUserSuccess(PendingResponse response, String message) {
        ...
        if (message.equalsIgnoreCase("ok") && response.getResult() != null && response.getResult().size() > 0) {
            ...
            binding.otherRecyclerView.setAdapter(new PendingAdapter(getContext(), response, this));
    ...
    @Override
    public void onPendingProfileClicked(String userId, String docId) {
    ...
    public void onCancelClickedListener(String documentId) {
        present.GetPendingCancelUser(getContext(), documentId);
    }
