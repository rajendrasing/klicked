package com.dating.klicked.AuidoTrimmer;
...
import com.dating.klicked.AuidoTrimmer.soundfile.SoundFile;
...
public class AudioTrimmerActivity extends AppCompatActivity implements WaveformView.WaveformListener, MarkerView.MarkerListener, MusicDesprictionPresenter.MusicDesprictionsView {
    ...
    private boolean mWasGetContentIntent,checkType;
    private WaveformView mWaveformView;
    private MarkerView mStartMarker;
    private MarkerView mEndMarker;
    private TextView mStartText, txt_upload, txt_reset;
    ...
    private String mCaption = "",PhoneNo;
    private int mWidth;
    private int mMaxPos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkType = intent.getBooleanExtra("checkType", false);

        mFilename = intent.getData().toString().replaceFirst("file://", "").replaceAll("%20", " ");
        Log.d("mFilenamemFilename", mFilename);
        mSoundFile = null;
        mKeyDown = false;
        ...
        userData = SharedPrefManager.getInstance(this).getLoginDATA();
        ...
        context = AudioTrimmerActivity.this;
    ...
    private void loadGui() {
        ...
        txt_reset.setOnClickListener(mResetListener);
        txt_upload = (TextView) findViewById(R.id.txt_upload);
        txt_upload.setOnClickListener(mUploadListener);
    ...
    private void recordAudio() {
        ...
        mFinishActivity = false;
        AlertDialog.Builder adBuilder = new AlertDialog.Builder(AudioTrimmerActivity.this);
    ...
    private void showFinalAlert(Exception e, CharSequence message) {
        ...
        new AlertDialog.Builder(AudioTrimmerActivity.this)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(
    ...
    public void onAudioDesUploadSuccess(ResponseBody responseBody, String message) {
        if (message.equalsIgnoreCase("ok")) {
            MyPreferences.getInstance(this).putString(PrefConf.CheckMusicsong,"false");
            Sneaker.with(this)
    ...
    public void onFavMusicUploadSuccess(ResponseBody responseBody, String message) {
        if (message.equalsIgnoreCase("ok")) {
            MyPreferences.getInstance(this).putString(PrefConf.CheckMusicsong,"ture");
            Sneaker.with(this)
    ...
    private void uploadAudio(File file,Boolean checkFile) {
